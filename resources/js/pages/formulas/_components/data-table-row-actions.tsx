...
export default function DataTableRowActions<TData extends Formula>({ row }: DataTableRowActionsProps<TData>) {
    ...
    return (
        <>
            ...
            >
                <FormulaForm formula={row.original} setIsOpen={setIsEditOpen} />
            </ResponsiveDialog>
            <ResponsiveDialog
            ...
            >
                <div className="flex flex-col items-end justify-center space-y-4">
                    <div className="flex space-x-2">
                        <Button variant="destructive" onClick={() => deleteFormula(row.original.id)}>
                            Delete
                        </Button>
